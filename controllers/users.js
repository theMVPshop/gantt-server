...
const getUser = (req, res) => {
  let sql =
    "SELECT user_id, first_name, last_name, email FROM Users WHERE Users.user_id = ? AND Users.user_id IS NOT NULL";
...
const loginUser = (req, res) => {
  ...
  let sql =
    "SELECT user_id, first_name, email, password FROM Users WHERE email = ?";
